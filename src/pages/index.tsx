        ...
        <ul>
          {lastestEpisodes.map((episode) => {
            return (
              <li key={episode.id}>
                {/* 
                  To make the Image component work
                  we need to configure next.config.ts
                  with the domains of our images
                */}
                <Image
                  width={192}
                  height={192}
                ...
                <div className={styles.episodeDetails}>
                  {/*
                    Link guarantees the SPA behavior
                    only re-rendering what has changed
                  */}
